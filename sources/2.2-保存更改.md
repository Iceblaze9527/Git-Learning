...
可以向`git diff`传递Git refs提交到diff。 一些示例引用是， `HEAD` ，标记和分支名称。 Git中的每个提交都有一个提交ID，您可以在执行`GIT LOG`时获得该ID。 您也可以将此提交ID传递给`git diff` 。



<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAxNjYzMDk4MiwtOTA2NTIwNDAzLC0zMj
