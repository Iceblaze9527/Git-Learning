...
git commit --amend
```
此选项为commit命令添加了另一级功能。 传递此选项将修改上次提交 而不是创建新的提交，更改将添加到以前的提交。 此命令将打开系统配置的文本编辑器，并提示更改先前指定的提交消息。
```
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM4MjE1NTIzOCwtOTMwMTEzNjYsLTI4ND
MzODI4NiwxOTMyOTI4NjUyLC01MTYyNDU1MzBdfQ==
-->