...
可以向`git diff`传递`commit`的 `Git refs`，比如`HEAD` ，`tags`和`branch`名称。 Git中的每个提交都有一个提交ID，您可以在执行`GIT LOG`时获得该ID。 您也可以将此提交ID传递给`git diff` 。



<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI4NzY2MjYwNywtOTA2NTIwNDAzLC0zMj
U1MzUzMTMsLTE5Mjg4NjM3NTAsLTkzMDExMzY2LC0yODQzMzgy
ODYsMTkzMjkyODY1MiwtNTE2MjQ1NTMwXX0=
-->