...
* ```git config --system core.editor <editor>``` : 定义当前机器所有用户使用命令时用到的文本编辑器，如 `git commit`。`<editor>` 参数用编辑器的启动命令（如 vi）替代。
...
#### 利用`git config`创建别名
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NjY4MzA4MjAsLTE2NzAyNTUyMDksLT
